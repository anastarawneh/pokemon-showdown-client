...
BattleMoveAnims['aquarush'] = {anim: BattleMoveAnims['aquajet'].anim};
BattleMoveAnims['murkchuck'] = {anim: BattleMoveAnims['sludgebomb'].anim};
...
BattleMoveAnims['spectralarrow'] = {anim: BattleMoveAnims['spiritshackle'].anim};
BattleMoveAnims['elementalarrow'] = {anim: BattleMoveAnims['triattack'].anim};
BattleMoveAnims['surprisepop'] = {anim: BattleMoveAnims['mistyexplosion'].anim};
BattleMoveAnims['shellexplosion'] = {anim: BattleMoveAnims['explosion'].anim};
...
BattleMoveAnims['muddycharge'] = {anim: BattleMoveAnims['headlongrush'].anim};
BattleMoveAnims['waterywithdrawal'] = {anim: BattleMoveAnims['wavecrash'].anim};
BattleMoveAnims['balefulhowl'] = {anim: BattleMoveAnims['hypervoice'].anim};
